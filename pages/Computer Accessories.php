...
<div id='product_cards' class="container">
    ...
    $product_counter = 0;
    $sql = 'SELECT id, pname, brand, price, discount, descr, filename FROM tbl_products WHERE category = "Computer Accessories"';
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '    <img src="/resources/products/' . $row['filename'] . '" class="card-img-top" style="height:35px width=35px 15vw;" alt="...">';
            ...
            echo '<center><a href="" class="btn btn-warning">View details</a></p>';
